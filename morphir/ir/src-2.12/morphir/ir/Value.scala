...
object Value{
  ...
  def collectPatternVariables[Va](
    ...
    pattern match {
      ...
      case morphir.ir.Value.TuplePattern(_, elemPatterns) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectPatternVariables)(elemPatterns))
      case morphir.ir.Value.ConstructorPattern(_, _, argPatterns) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectPatternVariables)(argPatterns))
      case morphir.ir.Value.EmptyListPattern(_) => 
        morphir.sdk.Set.empty
      case morphir.ir.Value.HeadTailPattern(_, headPattern, tailPattern) => 
  ...
  def collectReferences[Ta, Va](
    ...
    def collectUnion(
      ...
      morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectReferences)(values))
    ...
    value match {
      ...
      case morphir.ir.Value.LetRecursion(_, valueDefinitions, inValue) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.append(morphir.sdk.List(morphir.ir.Value.collectReferences(inValue)))(morphir.sdk.List.map(({
          case (_, _def) => 
      ...
      case morphir.ir.Value.PatternMatch(_, branchOutOn, cases) => 
        morphir.sdk.Set.union(morphir.ir.Value.collectReferences(branchOutOn))(collectUnion(morphir.sdk.List.map(morphir.sdk.Tuple.second)(cases)))
  ...
  def collectValueAttributes[Ta, Va](
    ...
    v match {
      ...
      case morphir.ir.Value.Tuple(a, elements) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.concatMap(morphir.ir.Value.collectValueAttributes)(elements))
      case morphir.ir.Value.List(a, items) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.concatMap(morphir.ir.Value.collectValueAttributes)(items))
      case morphir.ir.Value.Record(a, fields) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.concatMap(morphir.ir.Value.collectValueAttributes)(morphir.sdk.Dict.values(fields)))
      ...
      case morphir.ir.Value.LetRecursion(a, valueDefinitions, inValue) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.append(morphir.sdk.List.concatMap(morphir.sdk.Basics.composeRight(morphir.sdk.Tuple.second)(morphir.ir.Value.collectDefinitionAttributes))(morphir.sdk.Dict.toList(valueDefinitions)))(morphir.ir.Value.collectValueAttributes(inValue)))
      ...
      case morphir.ir.Value.UpdateRecord(a, valueToUpdate, fieldsToUpdate) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.append(morphir.ir.Value.collectValueAttributes(valueToUpdate))(morphir.sdk.List.concatMap(morphir.ir.Value.collectValueAttributes)(morphir.sdk.Dict.values(fieldsToUpdate))))
  ...
  def generateUniqueName[Ta, Va](
    ...
    val chars: morphir.sdk.List.List[morphir.sdk.List.List[morphir.sdk.String.String]] = morphir.sdk.List.map(morphir.sdk.List.singleton)(morphir.sdk.String.split("")("abcdefghijklmnopqrstuvwxyz"))
  ...
  def indexedMapValue[A, B, Ta](
    ...
    value match {
      ...
      case morphir.ir.Value.Tuple(a, elems) => 
        {
          val (mappedElems, elemsLastIndex) = morphir.ir.Value.indexedMapListHelp(morphir.ir.Value.indexedMapValue(f))(baseIndex)(elems)
      ...
      case morphir.ir.Value.List(a, values) => 
        {
          val (mappedValues, valuesLastIndex) = morphir.ir.Value.indexedMapListHelp(morphir.ir.Value.indexedMapValue(f))(baseIndex)(values)
  ...
  def isData[Ta, Va](
    ...
    value match {
      ...
      case morphir.ir.Value.Tuple(_, elems) => 
        morphir.sdk.List.all(morphir.ir.Value.isData)(elems)
      case morphir.ir.Value.List(_, items) => 
        morphir.sdk.List.all(morphir.ir.Value.isData)(items)
      case morphir.ir.Value.Record(_, fields) => 
        morphir.sdk.List.all(morphir.ir.Value.isData)(morphir.sdk.Dict.values(fields))
  ...
  def mapDefinition[E, Ta, Va](
    ...
    } : ((morphir.ir.Name.Name, Va, morphir.ir.Type.Type[Ta])) => morphir.sdk.Result.Result[E, (morphir.ir.Name.Name, Va, morphir.ir.Type.Type[Ta])]))(_def.inputTypes)))(morphir.sdk.Result.mapError(morphir.sdk.List.singleton)(mapType(_def.outputType)))(morphir.sdk.Result.mapError(morphir.sdk.List.singleton)(mapValue(_def.body)))
  ...
  def toRawValue[Ta, Va](
    ...
    morphir.ir.Value.mapValueAttributes(morphir.sdk.Basics.always({}))(morphir.sdk.Basics.always({}))(value)
        ...
        def valueToString(
          ...
          v match {
            ...
            case morphir.ir.Value.LetRecursion(_, defs, inValue) => 
              {
                def args(
                  def: morphir.ir.Value.Definition[Ta, Va]
    ...
    def liftLambdaArguments(
      ...
      (body, bodyType) match {
        case (morphir.ir.Value.Lambda(va, morphir.ir.Value.AsPattern(_, morphir.ir.Value.WildcardPattern(_), argName), lambdaBody), morphir.ir.Type.Function(_, argType, returnType)) => 
          liftLambdaArguments(morphir.sdk.Basics.append(args)(morphir.sdk.List((argName, va, argType))))(returnType)(lambdaBody)
        case _ => 
          morphir.ir.Value.Definition(
            body = body,
            inputTypes = args,
