...
object Module{
  ...
  def collectTypeReferences[Ta, Va](
    ...
    val typeRefs: morphir.sdk.Set.Set[morphir.ir.FQName.FQName] = morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.map(((typeDef: morphir.ir.AccessControlled.AccessControlled[morphir.ir.Documented.Documented[morphir.ir.Type.Definition[Ta]]]) =>
      typeDef.value.value match {
        ...
        case morphir.ir.Type.CustomTypeDefinition(_, ctors) => 
          morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.concatMap(((ctorArgs: morphir.sdk.List.List[(morphir.ir.Name.Name, morphir.ir.Type.Type[Ta])]) =>
    ...
    val valueRefs: morphir.sdk.Set.Set[morphir.ir.FQName.FQName] = morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.concatMap(((valueDef: morphir.ir.AccessControlled.AccessControlled[morphir.ir.Documented.Documented[morphir.ir.Value.Definition[Ta, Va]]]) =>
      morphir.sdk.List.map(morphir.ir.Type.collectReferences)(morphir.sdk.List.cons(valueDef.value.value.outputType)(morphir.sdk.List.map(({
        case (_, _, tpe) => 
          tpe
  ...
  def collectValueReferences[Ta, Va](
    ...
    morphir.sdk.List.foldl(morphir.sdk.Set.union)(morphir.sdk.Set.empty)(morphir.sdk.List.map(((valueDef: morphir.ir.AccessControlled.AccessControlled[morphir.ir.Documented.Documented[morphir.ir.Value.Definition[Ta, Va]]]) =>
      ...
      types = morphir.sdk.Dict.fromList(morphir.sdk.List.filterMap(({
        case (path, accessControlledType) => 
          morphir.sdk.Maybe.map(((typeDef: morphir.ir.Documented.Documented[morphir.ir.Type.Definition[Ta]]) =>
            (path, morphir.ir.Documented.map(morphir.ir.Type.definitionToSpecification)(typeDef))))(morphir.ir.AccessControlled.withPublicAccess(accessControlledType))
      ...
      values = morphir.sdk.Dict.fromList(morphir.sdk.List.filterMap(({
        case (path, accessControlledValue) => 
          morphir.sdk.Maybe.map(((valueDef: morphir.ir.Documented.Documented[morphir.ir.Value.Definition[Ta, Va]]) =>
            (path, morphir.ir.Documented.map(morphir.ir.Value.definitionToSpecification)(valueDef))))(morphir.ir.AccessControlled.withPublicAccess(accessControlledValue))
  ...
  def definitionToSpecificationWithPrivate[Ta, Va](
    ...
    morphir.ir.Module.Specification(
      ...
      types = morphir.sdk.Dict.fromList(morphir.sdk.List.map(({
        case (path, accessControlledType) => 
          (path, morphir.ir.Documented.map(morphir.ir.Type.definitionToSpecificationWithPrivate)(morphir.ir.AccessControlled.withPrivateAccess(accessControlledType)))
      ...
      values = morphir.sdk.Dict.fromList(morphir.sdk.List.map(({
        case (path, accessControlledValue) => 
          (path, morphir.ir.Documented.map(morphir.ir.Value.definitionToSpecification)(morphir.ir.AccessControlled.withPrivateAccess(accessControlledValue)))
  ...
  def lookupValueDefinition[Ta, Va](
    ...
    morphir.sdk.Maybe.map(morphir.sdk.Basics.composeRight(morphir.ir.AccessControlled.withPrivateAccess)(((x: morphir.ir.Documented.Documented[morphir.ir.Value.Definition[Ta, Va]]) =>
