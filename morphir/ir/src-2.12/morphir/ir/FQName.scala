...
object FQName {
  ...
  def fqn(
    ...
    morphir.ir.FQName.fQName(morphir.ir.Path.fromString(packageName))(morphir.ir.Path.fromString(moduleName))(
      morphir.ir.Name.fromString(localName)
    )
  ...
  def fromString(
    ...
    morphir.sdk.String.split(splitter)(fqNameString) match {
      case moduleNameString :: packageNameString :: localNameString :: Nil =>
        (
          morphir.ir.Path.fromString(moduleNameString),
