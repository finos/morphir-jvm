...
object Value{
  ...
  implicit def ordering: Ordering[Name] = (_: Name, _: Name) => 0
  ...
  def collectPatternAttributes[A](
    ...
    p match {
      ...
      case morphir.ir.Value.TuplePattern(a, elementPatterns) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.concatMap((p: Pattern[A]) => morphir.ir.Value.collectPatternAttributes(p))(elementPatterns))
      case morphir.ir.Value.ConstructorPattern(a, _, argumentPatterns) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.concatMap(morphir.ir.Value.collectPatternAttributes[A](_))(argumentPatterns))
  ...
  def collectPatternReferences[Va](
    ...
    pattern match {
      ...
      case morphir.ir.Value.TuplePattern(_, elemPatterns) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union[FQName])(morphir.sdk.Set.empty[FQName])(morphir.sdk.List.map(morphir.ir.Value.collectPatternReferences[Va](_))(elemPatterns))
      case morphir.ir.Value.ConstructorPattern(_, fQName, argPatterns) => 
        morphir.sdk.Set.insert(fQName)(morphir.sdk.List.foldl(morphir.sdk.Set.union[FQName])(morphir.sdk.Set.empty[FQName])(morphir.sdk.List.map(morphir.ir.Value.collectPatternReferences[Va])(argPatterns)))
  ...
  def collectPatternVariables[Va](
    ...
    pattern match {
      ...
      case morphir.ir.Value.TuplePattern(_, elemPatterns) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union[Name])(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectPatternVariables[Va])(elemPatterns))
      case morphir.ir.Value.ConstructorPattern(_, _, argPatterns) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union[Name])(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectPatternVariables[Va])(argPatterns))
      case morphir.ir.Value.EmptyListPattern(_) => 
        morphir.sdk.Set.empty
      case morphir.ir.Value.HeadTailPattern(_, headPattern, tailPattern) => 
  ...
  def collectReferences[Ta, Va](
    ...
    def collectUnion(
      ...
      morphir.sdk.List.foldl(morphir.sdk.Set.union[FQName])(morphir.sdk.Set.empty)(morphir.sdk.List.map(morphir.ir.Value.collectReferences[Ta, Va])(values))
    ...
    value match {
      ...
      case morphir.ir.Value.LetRecursion(_, valueDefinitions, inValue) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union[FQName])(morphir.sdk.Set.empty)(morphir.sdk.List.append(morphir.sdk.List(morphir.ir.Value.collectReferences(inValue)))(morphir.sdk.List.map(({
          case (_, _def) => 
  ...
  def collectValueAttributes[Ta, Va](
    ...
    v match {
      ...
      case morphir.ir.Value.LetRecursion(a, valueDefinitions, inValue) => 
        morphir.sdk.List.cons(a)(morphir.sdk.List.append(morphir.sdk.List.concatMap(morphir.sdk.Basics.composeRight(morphir.sdk.Tuple.second[Name, Definition[Ta, Va]])(morphir.ir.Value.collectDefinitionAttributes))(morphir.sdk.Dict.toList(valueDefinitions)))(morphir.ir.Value.collectValueAttributes(inValue)))
  ...
  def collectVariables[Ta, Va](
    ...
    def collectUnion(
      ...
      morphir.sdk.List.foldl(morphir.sdk.Set.union[Name])(morphir.sdk.Set.empty[Name])(morphir.sdk.List.map(morphir.ir.Value.collectVariables[Ta, Va])(values))
    ...
    value match {
      ...
      case morphir.ir.Value.LetRecursion(_, valueDefinitions, inValue) => 
        morphir.sdk.List.foldl(morphir.sdk.Set.union[Name])(morphir.sdk.Set.empty)(morphir.sdk.List.append(morphir.sdk.List(morphir.ir.Value.collectVariables(inValue)))(morphir.sdk.List.map(({
          case (defName, _def) => 
  ...
  def indexedMapValue[A, B, Ta](
    ...
    value match {
      ...
      case morphir.ir.Value.Tuple(a, elems) => 
        {
          val (mappedElems, elemsLastIndex) = morphir.ir.Value.indexedMapListHelp(morphir.ir.Value.indexedMapValue[A, B, Ta](f))(baseIndex)(elems)
      ...
      case morphir.ir.Value.List(a, values) => 
        {
          val (mappedValues, valuesLastIndex) = morphir.ir.Value.indexedMapListHelp(morphir.ir.Value.indexedMapValue[A, B, Ta](f))(baseIndex)(values)
  ...
  def mapDefinition[E, Ta, Va](
    ...
    morphir.sdk.Result.map3(((inputTypes: morphir.sdk.List.List[(morphir.ir.Name.Name, Va, morphir.ir.Type.Type[Ta])], outputType: morphir.ir.Type.Type[Ta], body: morphir.ir.Value.Value[Ta, Va]) =>
          (morphir.ir.Value.Definition(
            ...
            outputType,
            body
          ) : morphir.ir.Value.Definition[Ta, Va])))(morphir.ListOfResults.liftAllErrors(morphir.sdk.List.map(({
      case (name, attr, tpe) => 
      ...
      _val match {
        case morphir.ir.Value.Apply(tpe, morphir.ir.Value.Apply(_, morphir.ir.Value.Reference(_, (("morphir" :: Nil) :: ("s" :: "d" :: "k" :: Nil) :: Nil, ("maybe" :: Nil) :: Nil, "with" :: "default" :: Nil)), defaultValue), morphir.ir.Value.Apply(maybetpe, morphir.ir.Value.Apply(_, morphir.ir.Value.Reference(_, (("morphir" :: Nil) :: ("s" :: "d" :: "k" :: Nil) :: Nil,( "maybe" :: Nil) :: Nil, "map" :: Nil)), mapLambda), inputMaybe)) =>
          mapLambda match {
            ...
            case _ => 
              {
                val argName: Name = morphir.ir.Value.generateUniqueName(mapLambda)
  ...
  def toRawValue[Ta, Va](
    ...
    morphir.ir.Value.mapValueAttributes(morphir.sdk.Basics.always[Unit, Ta]({}))(morphir.sdk.Basics.always[Unit, Va]({}))(value)
    ...
    def literalToString(
      ...
      lit match {
        ...
        case morphir.ir.Literal.DecimalLiteral(decimal) => 
          morphir.sdk.Decimal.toString(decimal)
      }
  ...
  def typeAndValueToDefinition[Ta, Va](
    ...
    def liftLambdaArguments(
      ...
      (body, bodyType) match {
        case (morphir.ir.Value.Lambda(va, morphir.ir.Value.AsPattern(_, morphir.ir.Value.WildcardPattern(_), argName), lambdaBody), morphir.ir.Type.Function(_, argType, returnType)) => 
          liftLambdaArguments(morphir.sdk.List.concat(morphir.sdk.List(
            args,
            morphir.sdk.List((argName, va, argType))
    ...
    liftLambdaArguments(morphir.sdk.List(), valueType, value)
  }
