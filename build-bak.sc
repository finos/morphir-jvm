...
class CliModule(val crossScalaVersion: String) extends CrossScalaModule with MorphirCommonModule with PublishModule {
...
trait CommonPublishModule extends MorphirCommonModule with PublishModule with CrossScalaModule {
  def publishVersion     = productVersion
