...
//     Json.encoder.contramap[Module.Definition[Attributes]] { definition =>
//       Json.Obj(
...
//   implicit def packageDefinitionEncoder[TA, VA](implicit
//       taEncoder: JsonEncoder[TA],
//       vaEncoder: JsonEncoder[VA]
